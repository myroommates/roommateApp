...
public class TicketListFragment extends Fragment {
    ...
    private void printList(List<TicketDTO> list) {
        String a = "";
    ...
    private class RemoveRequest extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            WebClient<ResultDTO> webClient = new WebClient<ResultDTO>(RequestEnum.TICKET_REMOVE, ticketDTO.getId(), ResultDTO.class);
            try {
    ...
    private class RefreshRequest extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            WebClient<ListTicketDTO> webClient = new WebClient<ListTicketDTO>(RequestEnum.TICKET_GET, ListTicketDTO.class);
            try {
